            ...
            <div class="col-sm-6 containerBox">
                ...
                <div class="col-sm-12 text-center">
                    <a href="adminLogin.php">
                        <!-- change it to adminLogin.php when it is done -->
                        <input type="button" class="btn btn-dark" style="font-size:30px" name="home"
                            value="Click here to login to admin panel">
                    </a>
                    <br>
                    <br>
