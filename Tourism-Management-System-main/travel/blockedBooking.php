        ...
        <div class="container-fluid">
            <div class="col-sm-12 blocked">
                ...
                <div class="col-sm-6 containerBox">
                    ...
                    <div class="col-sm-12 text-center">
                        <a href="../../Online-Food-Ordering-System-in-PHP-main/registration.php">
                    ...
                    <div class="col-sm-12 text-center">
                        <div class="prompt">
                            Already have an account? <a href="../../Online-Food-Ordering-System-in-PHP-main/login.php"><span class="dots">Login</span></a> 
                        </div>
                    </div>
                </div>
