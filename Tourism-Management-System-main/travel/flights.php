                        ...
                        <form name="flightSearch" action="returnTripOutboundFlightSearch.php" method="POST">
                            ...
                            <div class="radioContainer">
                                ...
                                <div class="col-sm-6 text-right">
                                    ...
                                    <input type="radio" name="flightClass" value="Economy Class" id="economyClass"
                                        checked>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select id="origin" data-live-search="true" class="selectpicker form-control"
                                        data-size="5" title="Select Origin" name="origin" required>
                                        <option value="New Delhi" data-subtext="DEL" data-tokens="DEL New Delhi">New
                                            Delhi</option>
                                        <option value="Mumbai" data-subtext="BOM" data-tokens="BOM Mumbai">Mumbai
                                        </option>
                                        <option value="Kolkata" data-subtext="CCU" data-tokens="CCU Kolkata">Kolkata
                                        </option>
                                        <option value="Bengaluru" data-subtext="BLR" data-tokens="BLR Bengaluru">
                                            Bengaluru</option>
                                        <option value="Pune" data-subtext="PNQ" data-tokens="PNQ Pune">Pune</option>
                                        <option value="Chennai" data-subtext="MAA" data-tokens="MAA Chennai">Chennai
                                        </option>
                                        <option value="Guwahati" data-subtext="GAU" data-tokens="GAU Guwahati">Guwahati
                                        </option>
                                        <option value="Bhopal" data-subtext="BHO" data-tokens="BHI Bhopal">Bhopal
                                        </option>
                                        <option value="Jaipur" data-subtext="JAI" data-tokens="JAI Jaipur">Jaipur
                                        </option>
                                        <option value="Ahmedabad" data-subtext="AMD" data-tokens="AMD Ahmedabad">
                                            Ahmedabad</option>
                                        <option value="Hyderabad" data-subtext="HYD" data-tokens="HYD Hyderabad">
                                            Hyderabad</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select id="destination" data-live-search="true" class="selectpicker form-control"
                                        data-size="5" title="Select Destination" name="destination" required>
                                        <option value="New Delhi" data-subtext="DEL" data-tokens="DEL New Delhi">New
                                            Delhi</option>
                                        <option value="Mumbai" data-subtext="BOM" data-tokens="BOM Mumbai">Mumbai
                                        </option>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="datetimepicker1">
                                        <input id="datetime1" type="text" class="inputDate form-control"
                                            placeholder="Select Departure Date" name="depart" required />
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="datetimepicker2">
                                        <input id="datetime2" type="text" class="inputDate form-control"
                                            placeholder="Select Return Date" name="return" required />
                                        <span class="input-group-addon">
                                            <span class="fa fa-calendar"></span>
                                        </span>
                                    </div>
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="form-group">
                                    <select id="adults" class="selectpicker form-control" data-size="5"
                                        title="Aged 18 and above" name="adults" required>
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="form-group">
                                    <select id="children" class="selectpicker form-control" data-size="5"
                                        title="Aged upto 17" name="children" required>
