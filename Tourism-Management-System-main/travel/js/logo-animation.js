// Tourism Management Clean Logo JavaScript (Background Removed)
          ...
          <div class="logo-wrapper">
              <div class="logo-icon">
                  <div class="logo-circle">
                      <i class="fa fa-plane logo-plane"></i>
              ...
              <div class="logo-text">
                  <div class="brand-name">
                      <span class="letter" data-letter="T">J</span>
                      <span class="letter" data-letter="O">S</span>
                      <span class="letter" data-letter="U"> </span>
                      <span class="letter" data-letter="R">W</span>
                      <span class="letter" data-letter="I">E</span>
                      <span class="letter" data-letter="S">B</span>
                      <span class="letter" data-letter="M">Y</span>
                  </div>
                  ...
                  <div class="brand-tagline">
                      <span class="tagline-text">Explore • Book • Experience</span>
                  </div>
              </div>
          </div>
...
function addLogoStyles() {
  const styles = `
          ...
          .letter {
              ...
              background: linear-gradient(45deg, #3498db, #2ecc71, #ff6b6b, #feca57);
          ...
          .dynamic-logo-container:hover .logo-plane {
              color: #2ecc71;
          }
          </style>
      `;
...
console.log("🌟 Tourism Management Clean Logo Loaded Successfully! ✈️");
