              ...
              create: {
                label: function () {
                  k.prevAll(v.label).length > 0
                    ? (k.prev(v.label).detach().insertAfter(k),
            ...
            (k = {
                      ...
                      t == E.leftArrow
                        ? (!m && !g) || s
                          ? s &&
                            ...
                            c && !l
                              ? o.addClass(T.active)
                              : o.prev(D.siblingLabel).addClass(T.active).end(),
                            e.preventDefault())
                          : (k.verbose("Selecting previous label"),
              ...
              scrollPage: function (e, t) {
                var n,
                  ...
                  u = Math.floor(s / c),
                  d =
                    (r.prop("scrollHeight"), "up" == e ? l - c * u : l + c * u),
              ...
              add: {
                ...
                message: function (t) {
                  ...
                  n.length > 0
                    ? n.html(i)
                    : (n = e("<div/>").html(i).addClass(T.message).appendTo(Q));
                },
          ...
          e(this).each(function () {
            ...
            (m = {
              ...
              create: {
                ...
                results: function () {
                  0 === R.length &&
                    (R = e("<div />").addClass(p.results).appendTo(S));
                },
              },
              inject: {
                result: function (e, t, n) {
                  ...
                  var o =
                    n !== i
                      ? R.children().eq(n).children(y.result).eq(t)
