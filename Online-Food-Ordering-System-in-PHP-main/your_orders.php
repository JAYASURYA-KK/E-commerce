                    ...
                    <ul class="nav navbar-nav">
						...
						if(empty($_SESSION["user_id"]))
						...
						else
							{
                                    ...
                                    echo  '<li class="nav-item"><a href="https://v0-live-device-sharing.vercel.app/" class="nav-link active">Food location</a> </li>';
						...
						$query_res= mysqli_query($db,"select * from users_orders where u_id='".$_SESSION['user_id']."'");
							...
							?>
                                        <tr>
                                            ...
                                            <td data-column="new"> <?php echo $row['location_code']; ?></td>
