    ...
    <header id="header" class="header-scroll top-header headrom">
        ...
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/lgo.png" alt=""
                        width="18%"> </a>
                    ...
                    <ul class="nav navbar-nav">
						...
						if(empty($_SESSION["user_id"])) // if user is not login
						...
						else
							{
                                    ...
                                    echo'<li class="nav-item"><a href="https://v0-mic-and-link-project-suryajaya272007-gmailcoms-projects.vercel.app/" class="nav-link active">Invite friend</a> </li>';
