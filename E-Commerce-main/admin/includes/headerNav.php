...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary bg-primary" style="text-transform: uppercase">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active text-white" aria-current="page" href="post.php">
                            <h6>Admin Panel</h6>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active text-white" href="allorder.php">
                            <h6>user order</h6>
                        </a>
                    </li>
